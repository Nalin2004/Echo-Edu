...
export default function TutorPage() {
  ...
  const { generateSpeech, playAudio, stopAudio, isLoading: ttsLoading } = useTTS();
  ...
  const speakAssistantText = async (text, messageIndex) => {
  ...
  const handleTTSForMessage = async (messageIndex) => {
                  ...
                  {msg.role === 'assistant' && (
                    <div className="msg-controls">
                      <button
                        ...
                        disabled={ttsLoading}
                        aria-label={t('Play AI-generated speech')}
                        title={t('ElevenLabs Voice')}
                      >
          ...
          <div className="tutor-input-area" role="form" aria-label={t('Send a message')}>
            <div className="tutor-input-row">
              <textarea
                ...
                placeholder={`${t('Ask anything in')} ${currentLang.native}…`}
                value={input}
            ...
            <p className="tutor-hint" aria-live="off">
